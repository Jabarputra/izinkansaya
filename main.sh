...
function notif_bot() {
    ...
    USRSC=$(curl https://raw.githubusercontent.com/Ryuchiii/Jabarputra/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/Ryuchiii/Jabarputra/main/ip | grep $ipsaya | awk '{print $3}')
