...
echo -e "       © jabar vpn & Tekiro Project ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
function notif_bot() {
    ...
    USRSC=$(curl https://raw.githubusercontent.com/Javarputra/izinkansaya/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/Javarputra/izinkansaya/main/ip | grep $ipsaya | awk '{print $3}')
